(function registerCurriculum() {
  ...
  const stageSpecs = {
    ...
    'w1-baseline-intro': stageSpec('reflect', references.story({ rehearsalCount: 1, rehearsalKind: 'intro', withoutNotes: false })),
    ...
    'w3-checkpoint': stageSpec('learn', references.module('cnn-foundations', 'detection-segmentation-foundations', 'classical-cv-filtering', 'local-features-matching', 'geometric-vision', 'depth-and-stereo', 'point-clouds-3d', 'neural-3d')),
    ...
    'w4-similarity-design': stageSpec('practice', references.design('visual-similarity', 'attempt')),
    'w4-similarity-debrief': stageSpec('reflect', references.design('visual-similarity', 'debrief')),
    ...
    'w6-coding-mock': stageSpec('verify', references.mock('coding', 1, 'attempt')),
    'w6-mock-debrief': stageSpec('reflect', references.mock('coding', 1, 'debrief')),
    ...
    'w6-story-rehearse': stageSpec('verify', references.story({ rehearsalCount: 2, rehearsalKind: 'story', withoutNotes: false })),
    ...
    'w9-coding-debrief': stageSpec('reflect', references.mock('coding', 3, 'debrief')),
    ...
    'w10-loop-behavior': stageSpec('verify', references.story({ rehearsalCount: 8, rehearsalKind: 'full-round', withoutNotes: false })),
